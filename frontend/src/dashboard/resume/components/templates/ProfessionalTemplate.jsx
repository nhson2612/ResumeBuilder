 ...
 * 
 * Uses TwoColumnLayout with 63/37 split and gradient header.
...
function ProfessionalTemplate({ resumeInfo }) {
    ...
    // Header component with gradient and decorative pattern
    const header = (
        <>
            {/* Gradient header */}
            <div
