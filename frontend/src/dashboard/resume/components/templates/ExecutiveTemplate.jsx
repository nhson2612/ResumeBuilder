 ...
 * 
 * Uses TwoColumnLayout with 65/35 split.
 * Features gradient accent bar header and icon-box section titles.
 * Best for: Senior roles, executive positions, corporate environments.
 */
    ...
    const header = (
        <>
            ...
            <HeaderBlock
                ...
                gradient={{ from: themeColor, to: accentColor }}
    ...
    const rightColumn = (
        <>
            ...
            {resumeInfo?.skills?.length > 0 && (
                ...
                >
                    <div className="flex items-center gap-2 mb-3">
                        <span style={{ color: accentColor }}><SkillsIcon /></span>
                        <h3
            ...
            {resumeInfo?.Certifications?.length > 0 && (
                ...
                >
                    <div className="flex items-center gap-2 mb-3">
                        <span style={{ color: accentColor }}><CertIcon /></span>
                        <h3
                            className="text-xs font-bold uppercase tracking-widest"
                            style={{ color: themeColor }}
                        >
            ...
            {resumeInfo?.languages?.length > 0 && (
                ...
                >
                    <div className="flex items-center gap-2 mb-3">
                        <span style={{ color: accentColor }}><LanguageIcon /></span>
                        <h3
                            className="text-xs font-bold uppercase tracking-widest"
                            style={{ color: themeColor }}
                        >
            ...
            {resumeInfo?.awards?.length > 0 && (
                ...
                >
                    <div className="flex items-center gap-2 mb-3">
                        <span style={{ color: accentColor }}><AwardIcon /></span>
                        <h3
                            className="text-xs font-bold uppercase tracking-widest"
                            style={{ color: themeColor }}
                        >
